...
<body>
  ...
  <div class="d-flex align-items-center justify-content-center bg-sl-primary ht-100v">
    ...
    <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white">
      ...
      <div class="tx-center mg-b-60">Only Admin & Employee Will Login Here</div>
      <form action="login-post.php" method="POST">
        <div class="form-group">
          <input type="email" class="form-control LoginEmail" name="email" placeholder="Enter your username">
        ...
        <div class="form-group">
          <input type="password" class="form-control LoginPassword" name="password" placeholder="Enter your password">
          <span class="text-danger">
            <?php
      ...
      <div class="mg-t-60 tx-center">Not yet a member? <a href="signup-page.php" class="tx-info">Sign Up</a></div>
    </div><!-- login-wrapper -->
  </div><!-- d-flex -->
