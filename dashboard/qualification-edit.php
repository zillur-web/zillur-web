...
$id = $_GET['id'];
$select = "SELECT * FROM qualification WHERE id = '$id'";
...
<div class="sl-mainpanel">
	<nav class="breadcrumb sl-breadcrumb">
		...
		<a class="breadcrumb-item active" href="qualification-edit.php">Edit Qualification</a>
	</nav>

	<div class="sl-pagebody">
		<div class="sl-page-title">
			<div class="card pd-20 pd-sm-40">
				<h3 style="font-size: 25px;" class="card-body-title text-center text-info pb-5">Edit Qualification</h3>
				...
				<form action="qualification-edit-post.php" method="POST" enctype="multipart/form-data">
					<div class="form-layout">
						<div class="row mg-b-25">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="text" class="form-control tilteErr" id="title" placeholder="Enter Qualification Title" name="title" value="<?=$after_assoc['title']?>">
							...
							<div class="col-lg-4">
								<div class="form-group">
									...
									<input type="text" class="form-control year" id="year" placeholder="Enter Qualification Year" name="year" value="<?=$after_assoc['year']?>">
									<span class="text-danger">
										<?php
							...
							<div class="col-lg-2">
								<div class="form-group">
									...
									<select class="form-control result" id="result" name="result" value="<?=$after_assoc['result']?>">
										<?php
										for ($i=0; $i<=100; $i++){ 
											?>
						...
						<div class="row mg-b-25"><!-- row -->
							<div class="col-lg-6">
								<div class="form-group">
									...
									<select class="form-control experience" id="experience" name="experience" value="<?=$after_assoc['experience']?>">
										<?php
										for ($i=0; $i<10; $i++){ 
											?>
						...
						<div class="col-lg-6">
							<div class="form-group">
								...
								<input type="text" class="form-control phone" id="phone" placeholder="Enter Your Phone Number" name="phone" value="<?=$after_assoc['phone']?>">
								<span class="text-danger">
									<?php
