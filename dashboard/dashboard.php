        ...
        <div class="row row-sm">
          <div class="col-sm-6 col-xl-3">
            <div class="card pd-20 bg-primary">
              ...
              <div class="d-flex align-items-center justify-content-between">
                ...
                <h3 class="mg-b-0 tx-white tx-lato tx-bold"><?=$totaluser_count;?></h3>
              </div><!-- card-body -->
              <div class="d-flex align-items-center justify-content-between mg-t-15 bd-t bd-white-2 pd-t-10">
                <div>
                  <span class="tx-11 tx-white-6">Employee</span>
                  <h6 class="tx-white mg-b-0"><?=$employee_user_count;?></h6>
                </div>
                <div>
                  <span class="tx-11 tx-white-6">Normal User</span>
                  <h6 class="tx-white mg-b-0"><?=$simple_user_count;?></h6>
                </div>
              </div><!-- -->
            </div><!-- card -->
          </div><!-- col-3 -->
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
            <div class="card pd-20 bg-info">
              <div class="d-flex justify-content-between align-items-center mg-b-10">
                <h6 class="tx-11 tx-uppercase mg-b-0 tx-spacing-1 tx-white">Total Subscribers</h6>
                <a href="" class="tx-white-8 hover-white"><i class="icon ion-android-more-horizontal"></i></a>
              </div><!-- card-header -->
              <div class="d-flex align-items-center justify-content-between">
                <span class="sparkline2">5,3,9,6,5,9,7,3,5,2</span>
                <h3 class="mg-b-0 tx-white tx-lato tx-bold"><?=$total_sub_count;?></h3>
              </div><!-- card-body -->
              <div class="d-flex align-items-center justify-content-between mg-t-15 bd-t bd-white-2 pd-t-10">
                <div>
                  <span class="tx-11 tx-white-6">Response</span>
                  <h6 class="tx-white mg-b-0" style="font-size: 15px;">comming soon</h6>
                </div>
                <div>
                  <span class="tx-11 tx-white-6">Not Response</span>
                  <h6 class="tx-white mg-b-0" style="font-size: 15px;">comming soon</h6>
                </div>
              </div><!-- -->
            </div><!-- card -->
          ...
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="card pd-20 bg-purple">
              ...
              <div class="d-flex align-items-center justify-content-between">
                <span class="sparkline2">5,3,9,6,5,9,7,3,5,2</span>
                <h3 class="mg-b-0 tx-white tx-lato tx-bold"><?=$total_massage;?></h3>
              </div><!-- card-body -->
              <div class="d-flex align-items-center justify-content-between mg-t-15 bd-t bd-white-2 pd-t-10">
                <div>
                  <span class="tx-11 tx-white-6">Read</span>
                  <h6 class="tx-white mg-b-0"><?=$read_massage;?></h6>
                </div>
                <div>
                  <span class="tx-11 tx-white-6">Unread</span>
                  <h6 class="tx-white mg-b-0"><?=$massage_after_assoc;?></h6>
                </div>
              </div><!-- -->
            </div><!-- card -->
          </div><!-- col-3 -->
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="card pd-20 bg-sl-primary">
              <div class="d-flex justify-content-between align-items-center mg-b-10">
                <h6 class="tx-11 tx-uppercase mg-b-0 tx-spacing-1 tx-white">Total NOTIFICATIONS</h6>
                <a href="" class="tx-white-8 hover-white"><i class="icon ion-android-more-horizontal"></i></a>
              </div><!-- card-header -->
              <div class="d-flex align-items-center justify-content-between">
                <span class="sparkline2">5,3,9,6,5,9,7,3,5,2</span>
                <h3 class="mg-b-0 tx-white tx-lato tx-bold">coming</h3>
              </div><!-- card-body -->
              <div class="d-flex align-items-center justify-content-between mg-t-15 bd-t bd-white-2 pd-t-10">
                <div>
                  <span class="tx-11 tx-white-6">Read</span>
                  <h6 class="tx-white mg-b-0">00</h6>
                </div>
                <div>
                  <span class="tx-11 tx-white-6">Unread</span>
                  <h6 class="tx-white mg-b-0">00</h6>
