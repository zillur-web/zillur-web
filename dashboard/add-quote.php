...
<div class="sl-mainpanel">
	<nav class="breadcrumb sl-breadcrumb">
		...
		<a class="breadcrumb-item active" href="add-quote.php">Add Quote</a>
	</nav>

	<div class="sl-pagebody">
		<div class="sl-page-title">
			<div class="card pd-20 pd-sm-40">
				<h3 style="font-size: 25px;" class="card-body-title text-center text-info pb-5">Add Quote</h3>
						...
						<div class="row mg-b-25">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="text" class="form-control NameErr" id="name" placeholder="Enter Client Name" name="name">
							...
							<div class="col-lg-3"><!-- col-6 -->
								<div class="form-group">
									...
									<input class="image_ext_err image_size_Err form-control" type="file" id="client_img" class="form-control" name="image" onchange="document.getElementById('Client_image_id').src = window.URL.createObjectURL(this.files[0])">
									<span class="text-danger">
										<?php
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<div class="text-center">
										<img id="Client_image_id" style=" height: 150px; width: 150px;">
									</div>
								</div>
							</div> <!-- col-6 -->
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<textarea class="form-control quoteErr" id="quote" name="quote" rows="5" placeholder="Enter Client Say"></textarea>
									<span class="text-danger">
										<?php
