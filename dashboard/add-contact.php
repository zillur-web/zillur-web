	...
	<div class="sl-pagebody">
      ...
      ?>
			<div class="card pd-20 pd-sm-40">
				...
				<form action="add-contact-post.php" method="POST" enctype="multipart/form-data">
					<div class="form-layout">
						<div class="row mg-b-25">
							<div class="col-lg-6"><!-- col-6 -->
								<div class="form-group">
									<label for="address">Office Address: <span class="text-danger">*</span> </label>
									<input type="text" class="form-control addressErr" id="address" placeholder="Enter Your Office Address" name="address">
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="text" class="form-control cityErr" id="city" placeholder="Enter Office Address City & Country" name="city">
									<span class="text-danger">
										<?php
						...
						<div class="row mg-b-25">
							<div class="col-lg-6"><!-- col-6 -->
								<div class="form-group">
									...
									<input type="text" class="form-control phoneErr" id="phone" placeholder="Enter Office Phone Number" name="phone">
									<span class="text-danger">
										<?php
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="text" class="form-control timeErr" id="time" placeholder="Enter Office Time" name="time">
									<span class="text-danger">
										<?php
										if (isset($_SESSION['cityErr'])) {
											echo "<style>.cityErr{border:1px solid red;}</style>";
						...
						<div class="row mg-b-25"><!-- row -->
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="email" class="form-control emailErr" id="email" placeholder="Enter Office E-mail Address" name="email">
									<span class="text-danger">
										<?php
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<textarea class="form-control locationErr" id="location" name="location" rows="5" placeholder="Enter Embed A Map"></textarea>
									<span class="text-danger">
										<?php
