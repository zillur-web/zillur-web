...
$select = "SELECT * FROM about WHERE status = 'deactive'";
...
<div class="sl-mainpanel">
  <nav class="breadcrumb sl-breadcrumb">
    ...
    <a class="breadcrumb-item active" href="trush-about.php">Trush About Your Self</a>
  </nav>
  ...
  <div class="sl-pagebody">
    <div class="sl-page-title">
      ...
      ?>
      <h3 class="text-center">Trush About Your Self</h3>
        ...
        <tbody>
          <?php foreach ($query_data as $key => $value): ?>
            <tr>
              ...
              <td>
                <a class="btn btn-info" href="trush-about-restore.php?id=<?=$value['id'];?>"><i class="fas fa-trash-restore"></i> Restore</a>
                <button class="btn btn-danger TrushDelete" data-id="<?=$value['id']?>"><i class="far fa-trash-alt"></i> Delete</button>
              </td>
    ...
    .then((willDelete) => {
      if (willDelete) {
        ...
        window.setTimeout(function(){
          window.location.href = 'trush-about-delete.php?id='+id;
        }, 3000)
      } 
      else {
