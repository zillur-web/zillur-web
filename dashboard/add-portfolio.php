...
<div class="sl-mainpanel">
	<nav class="breadcrumb sl-breadcrumb">
		...
		<a class="breadcrumb-item active" href="add-portfolio.php">Add Portfolios</a>
	</nav>

	<div class="sl-pagebody">
		<div class="sl-page-title">
			<div class="card pd-20 pd-sm-40">
				<h3 style="font-size: 25px;" class="card-body-title text-center text-info pb-5">Add Portfolios</h3>
						...
						<div class="row mg-b-25">
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="text" class="form-control titleErr" id="title" placeholder="Enter Portfolio Title" name="title">
							...
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="text" class="form-control SubtitleErr" id="category" placeholder="Enter Portfolio Category" name="category">
									<span class="text-danger">
										<?php
						...
						<div class="row mg-b-25"><!-- row -->
							<div class="col-lg-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="demo" placeholder="Enter Website Design Link" name="demo_link">
								</div>
							</div><!-- col-4 -->
							<div class="col-lg-3"><!-- col-6 -->
								<div class="form-group">
									<label for="featured_image">Featured Image : <span class="text-danger">*</span> </label>
									<input class="image_size_Err image_file_err form-control" type="file" id="featured_image" class="form-control" name="featured_image" onchange="document.getElementById('featured_image_id').src = window.URL.createObjectURL(this.files[0])">
									<span class="text-danger">
										<?php
							...
							<div class="col-lg-3">
								<div class="form-group">
									...
									<div class="text-center">
										<img id="featured_image_id" style=" height: 150px; width: 150px;">
									</div>
								</div>
							</div> <!-- col-6 -->
