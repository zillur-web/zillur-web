...
<div class="sl-mainpanel">
	<nav class="breadcrumb sl-breadcrumb">
		...
		<a class="breadcrumb-item active" href="services-edit.php">Edit Services</a>
	</nav>
						...
						<div class="row mg-b-25"><!-- row -->
							<div class="col-lg-6"><!-- col-6 -->
								<div class="form-group">
									...
									<input type="text" class="form-control TitleErr" id="title" placeholder="Enter Services Title" name="title" value="<?=$after_assoc['title']?>">
							...
							<div class="col-lg-6">
								<div class="form-group">
									<label for="icon">Icon:   <span class="text-danger">  <?=$after_assoc['icon']?></span> </label>
							...
							<div class="col-lg-12">
								<div class="form-group">
									...
									<textarea class="form-control discriptionErr" id="discription" name="discription" rows="5" placeholder="Discription" value="<?=$after_assoc['discription']?>"></textarea>
								</div>
								<span class="text-danger">
									<?php
